    ...
    def _store_generic_live(self, station_id, live_record):
        query = """update live_data
            set download_timestamp = %(download_timestamp)s,
                ...
                mean_sea_level_pressure = %(msl_pressure)s,
    ...
    def _store_davis_live(self, station_id, live_record):
        ...
        query = """update davis_live_data
                set bar_trend = %(bar_trend)s,
                    ...
                    average_wind_speed_2m = %(average_wind_speed_2m)s,
                    average_wind_speed_10m = %(average_wind_speed_10m)s,
                    gust_wind_speed_10m = %(gust_wind_speed_10m)s,
                    gust_wind_direction_10m = %(gust_wind_direction_10m)s,
                    heat_index = %(heat_index)s,
                    thsw_index = %(thsw_index)s,
                    altimeter_setting = %(altimeter_setting)s,
