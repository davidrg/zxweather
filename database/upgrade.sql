...
BEGIN
  ...
  INSERT INTO live_data(station_id) VALUES( new_station_id);
...
BEGIN
  ...
  where (
    ...
    OR old.wind_direction <> ws.wind_direction
    OR (old.wind_direction is null and ws.wind_direction is not null)
    OR (old.wind_direction is not null and ws.wind_direction is null)
