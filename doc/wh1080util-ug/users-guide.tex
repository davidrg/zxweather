...
This operation inserts new records into a compatible PostgreSQL database. The required database structure is described in \emph{zxweather Database Structure} (document DAZW-DB01).
