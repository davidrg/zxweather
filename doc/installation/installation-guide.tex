...
Only one instance of \verb|db_push.py| should be run at a time to prevent possible corruption of the remote database.
...
\multirow{6}{*}{\parbox{4.5cm}{Verification failed - bad or missing signature. Status: no public key}} & Key not installed & Install public key (Section \ref{sec_dbr_installing_keys}) \\[0.2cm]
 ...
 & GnuPG Home Directory does not exist & Follow instructions in Section \ref{sec_dbr_installing_keys}. \\
\hline
\end{tabular}
