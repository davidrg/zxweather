...
The web interface is written as a Python WSGI application. This section only covers installing the application under Apache httpd. If you are using a different web server then consult the documentation for your servers wsgi module.
