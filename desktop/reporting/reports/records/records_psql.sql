select data.station_id,
       ...
       round(data.min_absolute_pressure::numeric, 1)::varchar as min_absolute_pressure,
       max(data.min_absolute_pressure_ts)::varchar as min_absolute_pressure_ts,
	   min(data.min_absolute_pressure_ts)::varchar as min_absolute_pressure_ts_min,
       round(data.max_absolute_pressure::numeric, 1)::varchar as max_absolute_pressure,
       max(data.max_absolute_pressure_ts)::varchar as max_absolute_pressure_ts,
	   min(data.max_absolute_pressure_ts)::varchar as max_absolute_pressure_ts_min,
