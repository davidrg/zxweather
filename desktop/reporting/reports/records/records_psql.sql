select data.station_id,
       ...
       max(data.min_absolute_pressure_ts)::varchar as min_absolute_pressure_ts,
       data.max_absolute_pressure,
       max(data.max_absolute_pressure_ts)::varchar as max_absolute_pressure_ts,
       round(data.min_apparent_temperature::numeric, 1) as min_apparent_temperature,
       max(data.min_apparent_temperature_ts)::varchar as min_apparent_temperature_ts,
       round(data.max_apparent_temperature::numeric, 1) as max_apparent_temperature,
       max(data.max_apparent_temperature_ts)::varchar as max_apparent_temperature_ts,
       round(data.min_wind_chill::numeric, 1) as min_wind_chill,
       max(data.min_wind_chill_ts)::varchar as min_wind_chill_ts,
       round(data.max_wind_chill::numeric, 1) as max_wind_chill,
       max(data.max_wind_chill_ts)::varchar as max_wind_chill_ts,
       round(data.min_dew_point::numeric, 1) as min_dew_point,
       max(data.min_dew_point_ts)::varchar as min_dew_point_ts,
       round(data.max_dew_point::numeric, 1) as max_dew_point,
