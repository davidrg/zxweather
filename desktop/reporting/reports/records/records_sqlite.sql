select data.station_id,
    ...
    round(data.total_rainfall, 1)::varchar as total_rainfall,
	...
	datetime(min(data.max_gust_wind_speed_ts), 'unixepoch') as max_gust_wind_speed_ts_min,
    round(data.max_average_wind_speed, 1)::varchar as max_average_wind_speed,
    datetime(max(data.max_average_wind_speed_ts), 'unixepoch') as max_average_wind_speed_ts,
	datetime(min(data.max_average_wind_speed_ts), 'unixepoch') as max_average_wind_speed_ts_min,
    round(data.min_absolute_pressure, 1)::varchar as min_absolute_pressure,
    datetime(max(data.min_absolute_pressure_ts), 'unixepoch') as min_absolute_pressure_ts,
	datetime(min(data.min_absolute_pressure_ts), 'unixepoch') as min_absolute_pressure_ts_min,
    round(data.max_absolute_pressure, 1)::varchar as max_absolute_pressure,
    datetime(max(data.max_absolute_pressure_ts), 'unixepoch') as max_absolute_pressure_ts,
	datetime(min(data.max_absolute_pressure_ts), 'unixepoch') as max_absolute_pressure_ts_min,
    round(data.min_apparent_temperature, 1)::varchar as min_apparent_temperature,
    datetime(max(data.min_apparent_temperature_ts), 'unixepoch') as min_apparent_temperature_ts,
	datetime(min(data.min_apparent_temperature_ts), 'unixepoch') as min_apparent_temperature_ts_min,
    round(data.max_apparent_temperature, 1)::varchar as max_apparent_temperature,
    datetime(max(data.max_apparent_temperature_ts), 'unixepoch') as max_apparent_temperature_ts,
	datetime(min(data.max_apparent_temperature_ts), 'unixepoch') as max_apparent_temperature_ts_min,
    round(data.min_wind_chill, 1)::varchar as min_wind_chill,
    datetime(max(data.min_wind_chill_ts), 'unixepoch') as min_wind_chill_ts,
	datetime(min(data.min_wind_chill_ts), 'unixepoch') as min_wind_chill_ts_min,
    round(data.max_wind_chill, 1)::varchar as max_wind_chill,
    datetime(max(data.max_wind_chill_ts), 'unixepoch') as max_wind_chill_ts,
	datetime(min(data.max_wind_chill_ts), 'unixepoch') as max_wind_chill_ts_min,
    round(data.min_dew_point, 1)::varchar as min_dew_point,
    datetime(max(data.min_dew_point_ts), 'unixepoch') as min_dew_point_ts,
	datetime(min(data.min_dew_point_ts), 'unixepoch') as min_dew_point_ts_min,
    round(data.max_dew_point, 1)::varchar as max_dew_point,
    datetime(max(data.max_dew_point_ts), 'unixepoch') as max_dew_point_ts,
	datetime(min(data.max_dew_point_ts), 'unixepoch') as max_dew_point_ts_min,
    round(data.min_temperature, 1)::varchar as min_temperature,
    datetime(max(data.min_temperature_ts), 'unixepoch') as min_temperature_ts,
	datetime(min(data.min_temperature_ts), 'unixepoch') as min_temperature_ts_min,
    round(data.max_temperature, 1)::varchar as max_temperature,
    datetime(max(data.max_temperature_ts), 'unixepoch') as max_temperature_ts,
	datetime(min(data.max_temperature_ts), 'unixepoch') as max_temperature_ts_min,
    round(data.min_humidity, 0)::varchar as min_humidity,
    datetime(max(data.min_humidity_ts), 'unixepoch') as min_humidity_ts,
	datetime(min(data.min_humidity_ts), 'unixepoch') as min_humidity_ts_min,
    round(data.max_humidity, 0)::varchar as max_humidity,
    datetime(max(data.max_humidity_ts), 'unixepoch') as max_humidity_ts,
	datetime(min(data.max_humidity_ts), 'unixepoch') as max_humidity_ts_min,
    round(data.max_solar_radiation, 1)::varchar as max_solar_radiation,
    datetime(max(data.max_solar_radiation_ts), 'unixepoch') as max_solar_radiation_ts,
	datetime(min(data.max_solar_radiation_ts), 'unixepoch') as max_solar_radiation_ts_min,
    round(data.max_uv_index, 1)::varchar as max_uv_index,
    datetime(max(data.max_uv_index_ts), 'unixepoch') as max_uv_index_ts,
	datetime(min(data.max_uv_index_ts), 'unixepoch') as max_uv_index_ts_min,
    round(data.max_rain_rate, 1)::varchar as max_rain_rate,
    datetime(max(data.max_rain_rate_ts), 'unixepoch') as max_rain_rate_ts,
	datetime(min(data.max_rain_rate_ts), 'unixepoch') as max_rain_rate_ts_min,
    round(data.max_evapotranspiration, 1)::varchar as max_evapotranspiration,
    datetime(max(data.max_evapotranspiration_ts), 'unixepoch') as max_evapotranspiration_ts,
	datetime(min(data.max_evapotranspiration_ts), 'unixepoch') as max_evapotranspiration_ts_min
from (
