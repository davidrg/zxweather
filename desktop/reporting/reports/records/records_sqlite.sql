select data.station_id,
    ...
    datetime(max(data.min_absolute_pressure_ts), 'unixepoch', 'localtime') as min_absolute_pressure_ts,
    datetime(min(data.min_absolute_pressure_ts), 'unixepoch', 'localtime') as min_absolute_pressure_ts_min,
    cast(round(data.max_absolute_pressure, 1) as text) as max_absolute_pressure,
    datetime(max(data.max_absolute_pressure_ts), 'unixepoch', 'localtime') as max_absolute_pressure_ts,
    datetime(min(data.max_absolute_pressure_ts), 'unixepoch', 'localtime') as max_absolute_pressure_ts_min,
