...
#include "ui_timespanwidget.h"

TimespanWidget::TimespanWidget(QWidget *parent) :
    QWidget(parent),
    ui(new Ui::TimespanWidget)
{
    ui->setupUi(this);
...
void TimespanWidget::dateChanged() {
...
QDateTime TimespanWidget::getStartTime() {
...
QDateTime TimespanWidget::getEndTime() {
    QDateTime time = QDateTime::currentDateTime();
...
void TimespanWidget::setTimeSpan(QDateTime start, QDateTime end) {
