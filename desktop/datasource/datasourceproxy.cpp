...
void DataSourceProxy::connectDataSources() {
    ...
    connect(liveSource, SIGNAL(liveConnectFailed(QString)),
            this, SLOT(liveConnectFailedSlot(QString)));
    connect(liveSource, SIGNAL(liveConnected()),
            this, SLOT(liveConnectedSlot()));
