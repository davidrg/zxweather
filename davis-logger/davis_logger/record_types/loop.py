...
import datetime
import struct
from davis_logger.record_types.util import CRC, c_to_f, ms_to_mph, mm_to_inch, inch_to_mm, f_to_c, mph_to_ms
...
def deserialise_loop(loop_string):
    ...
    inside_humidity, outside_temperature, wind_speed, average_wind_speed_10m, \
    wind_direction, ext_temp_1, ext_temp_2, ext_temp_3, ext_temp_4, \
    ext_temp_5, ext_temp_6, ext_temp_7, soil_temp_1, soil_temp_2, soil_temp_3, \
    soil_temp_4, leaf_temp_1, leaf_temp_2, leaf_temp_3, leaf_temp_4, \
    outside_humidity, ext_humid_1, ext_humid_2, ext_humid_3, ext_humid_4, \
    ext_humid_5, ext_humid_6, ext_humid_7, rain_rate, uv, solar_radiation, \
...
def serialise_loop(loop):
    ...
    format = '<3sbBhhhBhBBh7B4B4BB7BhBhhhhhhhhh4B4BBB2B8B4BBhBBHH'
    ...
    packed = struct.pack(
        ...
        loop.nextRecord,
        loop.barometer * 1000, # TODO: hPa conversion
